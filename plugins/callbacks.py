...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("MAIN CHANNEL", url="https://t.me/AJmovieLINKS"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/worldmoviesaj"),
                    InlineKeyboardButton("Support Group", url="https://t.me/AJmovieLINKS")
                ]
            ]
        )
